...
while 1:
    ...
    cv2.setMouseCallback('cam',colorPick)
    ...
    for i in contour:
        ...
        if area>500:
            ...
            img = cv2.rectangle(webcam,(x,y),(x+w,y+h),(0,120,255),2)
            cv2.putText(webcam,"color1 detected",(x,y),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0,0,255))
        
    cv2.imshow('cam',webcam)
